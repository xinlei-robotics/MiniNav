...
$$
\hat{v} = v + \mathcal{N}\left(0,\ \alpha_1 v^2 + \alpha_2 \omega^2\right)
$$

$$
\hat{\omega} = \omega + \mathcal{N}\left(0,\ \alpha_3 v^2 + \alpha_4 \omega^2\right)
$$
...
\Delta \text{ticks}_l =
\mathrm{round}\left(
\frac{v_{l,\mathrm{meas}} \cdot \Delta t}
{\Delta s_{\mathrm{tick}}}
\right)
$$
...
其中 $v_{\cdot,\text{meas}}$ 由 Δticks 反解：

$$v_{\cdot,\text{meas}} \approx \Delta\text{ticks}_{\cdot} \cdot \frac{\Delta s_{\text{tick}}}{\Delta t}$$
